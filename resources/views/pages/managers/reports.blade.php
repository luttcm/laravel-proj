    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            ...
            <div style="display: flex; gap: 16px; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 1px solid #e0e0e0;">
                ...
                <a href="{{ route('managers.reports') }}" style="padding: 8px 16px; display: none; background-color: #0084ff; color: white; border-radius: 6px; text-decoration: none; font-weight: 500; transition: all 0.2s;">
                    Отчёты
                </a>
