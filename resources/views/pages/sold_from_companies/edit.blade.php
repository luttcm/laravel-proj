...
@section('title', 'Редактировать компанию (ОТ КОГО)')
        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Редактировать компанию (ОТ КОГО)</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('sold-from-companies.update', $company->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
