                ...
                <form id="calculationForm">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="spk_id" id="spk_id" style="border-radius: 6px; border: 1px solid #e0e0e0; padding: 10px 12px;">
                                <option value="">НЕТ</option>
                                @foreach($spks as $spk)
                                    <option value="{{ $spk->id }}">{{ $spk->fio }}</option>
                                @endforeach
                            </select>
                            <input type="hidden" name="spk" id="spk_hidden" value="N">
                        </div>
                    </div>
        ...
        fetch(`/managers/reports/${id}`)
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('spk_id').value = calc.spk_id || '';
                    document.getElementById('spk_hidden').value = calc.spk_id ? 'Y' : 'N';
